...
public class adaugare extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Adauga o noua inregistrare:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Statement stmt;
           ...
           try (Connection con = DriverManager.getConnection(host, uName, Pass)) {
               ...
               rs.moveToInsertRow();
               rs.updateInt("COD_CD",a);
rs.updateInt("AN_APARITIE_CD",b);
               rs.updateString("ARTIST",c);              
                 rs.insertRow();            
            stmt.close();
            rs.close();
           }       }
        ...
        jLabel5.setText("Inregistrarea a fost efectuata cu succes!");
